...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#222222]">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-[#1E73BE] shadow-lg border-t-2 border-[#71BBEC]">
        <div className="flex items-center justify-center gap-0">
          {/* WhatsApp button */}
          <a
            href="https://wa.me/351910675168?text=Hi%20Algarve%20Seasons%2C%20I%27m%20interested%20in%20HVAC%20installation%20for%20my%20property%20in%20the%20Algarve."
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 flex items-center justify-center gap-2 py-3 text-white hover:bg-[#155A95] transition-colors duration-150 text-sm font-semibold uppercase tracking-wide border-r border-white/20"
            style={{ fontFamily: "'Josefin Sans', sans-serif", letterSpacing: "0.08em" }}
            aria-label="Chat with Algarve Seasons on WhatsApp"
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004c-1.537 0-2.852-.503-3.822-1.46-.977-.968-1.522-2.265-1.522-3.665 0-2.955 2.414-5.478 5.339-5.478 1.437 0 2.79.556 3.802 1.561 1.021 1.01 1.583 2.353 1.583 3.779 0 2.965-2.422 5.475-5.378 5.475m5.892 12.061H3.552c-1.289 0-2.386-.882-2.386-2.099V3.575c0-1.216 1.097-2.099 2.386-2.099h16.896c1.289 0 2.386.882 2.386 2.099v15.383c0 1.217-1.097 2.099-2.386 2.099"/>
            </svg>
            WhatsApp
          </a>
          ...
          <a
            href="tel:+351910675168"
            className="flex-1 flex items-center justify-center gap-2 py-3 text-white hover:bg-[#155A95] transition-colors duration-150 text-sm font-semibold uppercase tracking-wide"
            style={{ fontFamily: "'Josefin Sans', sans-serif", letterSpacing: "0.08em" }}
            aria-label="Call Algarve Seasons"
          >
            <Phone size={18} />
            Call Now
          </a>
      ...
      {/* Padding to prevent content overlap with sticky bar */}
